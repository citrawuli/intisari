...
<head>
    ...
    <title>Laravel Intisari</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="stylesheet" href="{{ asset('backend/css/bootstrap.min.css') }}" />

    <link rel="shortcut icon" type="image/png" href="{{ asset('backend/images/icon/logo4.png') }}">
    <link rel="stylesheet" href="{{ asset('backend/css/bootstrap.min.css') }}">
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">  
                <div class="logo">
                    <a href="{{ url('/') }}"><img src="{{ asset('backend/images/icon/logo4.png') }}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-dashboard"></i><span>Customer</span></a>
                                <ul class="collapse">
                                    <li class=""><a href="{{ url('/TabelCustomer') }}">data customer</a></li>
                                    <li><a href="{{ url('/TambahCustomerBlob') }}">tambah customer 1 - blob saja</a></li>
                                    <li><a href="{{ url('/TambahCustomerFilename') }}">tambah customer 2- blob dan path</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Cetak label TnJ 108
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('/ListBarang') }}">List Barang</a></li>
                                    <li><a href="{{ url('/BarcodeScanner') }}">Barcode Scanner</a></li>
                                    <li><a href="{{ url('/BarcodeGenerator') }}">Barcode Generator</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-map-alt"></i><span>Kunjungan Toko
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('/ListToko') }}">List Lokasi Toko</a></li>
                                    <li><a href="{{ url('/TitikAwal') }}">Input Titik Awal</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                <input type="text" name="search1" placeholder="Search..." required>
                                <i class="ti-search"></i>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Citra Ayu <i class="fa fa-angle-down"></i></h4>
    ...
    <script>
        ...
        function move(){
            console.log("masuk function move");
            resetTimer();
        }
    </script>
